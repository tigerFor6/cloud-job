...
public class CustomerPositionCountJob extends QuartzJobBean {

    private static final Logger LOGGER = LoggerFactory.getLogger(CustomerPositionCountJob.class);
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) {
        customerCalculateFeign.updateCustPositionCounts();
        System.out.println("客户持仓峰值信息更新成功"+ new Date());
    }
}
