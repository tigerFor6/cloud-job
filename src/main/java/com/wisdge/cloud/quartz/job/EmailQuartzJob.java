...
public class EmailQuartzJob extends QuartzJobBean {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(EmailQuartzJob.class);
    @Autowired
